...
<head>
    <title>All Advertisements - Subotica Rentals</title>
    <meta charset="utf-8" />
                ...
                foreach ($adverts as $ad) {
                    ...
                    "<div class='item'>
                        ...
                        <div class='info'>
                            ...
                            <span class='btn-bar'>
                                <a href='#' id='$ad->id-view1' data-ad-id='$ad->id' class='button-primary button-sm'><i class='bi bi-eye-fill'></i> View</a>
                                $editButton
                                $blockActionButton
